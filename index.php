			...
			<div class="container">
				...
				<div class="row">
					...
					<p>Adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
						volup tatem. Uteni ad minima veniam, quis nostrum sed quia non numquam eius modi tempora incidunt ut. quia non
						numquam eius numquam eius modi temp modi tempora incidunt ut labore et dolore m.</p>
						...
						<div class="row row-cols">
							...
							<div class="col-md-4 col-get-in-touch">
								...
								<div class="row-fluid visible-xs">
									<div class="col-xs-6">
										<a href="#" class="brn btn-footer "><i class="fa fa-map-marker"></i>location</a>
									</div>
									<div class="col-xs-6">
										<a href="#" class="brn btn-footer "><i class="fa fa-phone"></i>Call</a>
								...
								<ul class="list-unstyled list-socials">
									<li>
										<a href="https://www.facebook.com/juan.pereira.90" target="_blank"><i class="fa fa-facebook"></i></a>
									</li>
									<li>
